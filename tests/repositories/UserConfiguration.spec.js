const userConfirgurationPath = '../../src/repositories/UserConfiguration';
const chai = require('chai');
const sinon = require('sinon');
const sinonChai = require('sinon-chai');
const expect = chai.expect;
const chaiAsPromised = require('chai-as-promised');
const UserConfiguration = require(userConfirgurationPath);
...
describe('UserConfiguration', () => {
  ...
  describe('#readUserConfiguration()', () => {
    ...
    const ProxyUserConfiguration = proxyquire(userConfirgurationPath, {
